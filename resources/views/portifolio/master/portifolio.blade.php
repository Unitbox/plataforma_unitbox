            ...
            <nav class="js-mega-menu navbar-nav-wrap">
                ...
                <div class="collapse navbar-collapse" id="navbarNavDropdown">
                    <ul id="navbarNavDropdownNav" class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="#learnSection">Learn</a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="#hireUsSection">Hire Us</a>
                        </li>
    ...
    <main id="content" role="main">
            ...
            <div
                ...
                <div class="row justify-content-lg-between align-items-md-center">
                    <div class="col-md-6 col-lg-5 mb-10 mb-md-0">
                        <div class="mb-5">
                            <h1 class="display-4">
                                <span class="text-primary text-highlight-warning">Aplicativos</span>
                                & <span class="text-primary text-highlight-warning">Sites responsivos</span>
                            </h1>
                        ...
                        <div class="d-flex align-items-center gap-2 mb-8">
                            ...
                            <!-- Fancybox -->
                            <a class="video-player btn btn-outline-primary btn-transition"
                        ...
                        <div class="row justify-content-end">
                            ...
                            <div class="col-4 mb-4">
                                ...
                                <div class="d-block avatar avatar-xl rounded-circle shadow-sm p-4 mx-auto mt-5"
                                    ...
                                    <img class="avatar-img" src="./assets/svg/brands/atlassian-icon.svg"
                                        alt="Image Description">
                                </div>
                                <!-- End Logo -->
                            </div>
                            <div class="col-4 mb-4">
                                ...
                                <div class="d-block avatar avatar-xl rounded-circle shadow-sm p-4 ms-auto"
                                    ...
                                    <img class="avatar-img" src="./assets/svg/brands/asana-icon.svg"
                                        alt="Image Description">
                                </div>
                                <!-- End Logo -->
                            </div>
                        ...
                        <div class="row">
                            <div class="col-3 offset-1 my-4">
                                ...
                                <div class="d-block avatar avatar-xl rounded-circle shadow-sm p-4 ms-auto"
                                    ...
                                    <img class="avatar-img" src="./assets/svg/brands/paypal-icon.svg"
                                        alt="Image Description">
                                </div>
                                <!-- End Logo -->
                            </div>
                            <div class="col-3 offset-2 my-4">
                                ...
                                <div class="d-block avatar avatar-xl rounded-circle shadow-sm p-4 ms-auto"
                                    ...
                                    <img class="avatar-img" src="./assets/svg/brands/dribbble-icon.svg"
                                        alt="Image Description">
                                </div>
                                <!-- End Logo -->
                            </div>
                        ...
                        <div class="row d-none d-md-flex">
                            <div class="col-6">
                                ...
                                <div class="d-block avatar avatar-lg rounded-circle shadow-sm p-3 ms-auto"
                                    ...
                                    <img class="avatar-img" src="./assets/svg/brands/google-adz-icon.svg"
                                        alt="Image Description">
                                </div>
                                <!-- End Logo -->
                            </div>
                            <div class="col-6 mt-6">
                                ...
                                <div class="d-block avatar avatar-xl rounded-circle shadow-sm p-4 ms-auto"
                                    ...
                                    <img class="avatar-img" src="./assets/svg/brands/behance-icon.svg"
                                        alt="Image Description">
                                </div>
                                <!-- End Logo -->
                            </div>
                ...
                <div class="col-sm-6 col-lg-3 mb-3 mb-lg-0">
                    ...
                    <a class="card card-sm card-transition h-100" href="#">
                        <div class="card-body">
                            ...
                            <p class="card-text text-body">Front template can be easily customized with its
                                cutting-edge components and features.</p>
                        </div>
                ...
                <div class="col-sm-6 col-lg-3 mb-3 mb-sm-0">
                    ...
                    <a class="card card-sm card-transition h-100" href="#">
                        <div class="card-body">
                            ...
                            <h4 class="card-title">Premium <span
                                    class="badge badge-success badge-pill ml-1">sketch</span></h4>
        ...
        <div id="learnSection" class="container content-space-2 content-space-lg-3">
            ...
            <div class="w-md-75 w-lg-50 text-center mx-md-auto mb-5 mb-md-9">
                ...
                <p>Front is an incredibly beautiful, fully responsive, and mobile-first projects on the web – it is the
                ...
                <div class="row justify-content-lg-center align-items-md-center">
                    <div class="col-md-5 mb-10 mb-md-0">
                        <div class="position-relative">
                            <img class="img-fluid rounded-2" src="./assets/img/800x900/img1.jpg"
                                alt="Image Description">
                    ...
                    <div class="col-md-6 col-lg-5">
                        <div class="ps-md-6">
                            <div class="mb-4">
                                <img class="avatar avatar-xl avatar-4x3" src="./assets/svg/brands/hubspot-dark.svg"
                                    alt="Image Description">
                            </div>

                            <!-- Blockquote -->
                            <figure>
                                <blockquote class="blockquote blockquote-lg">" The template is really nice and offers
                                    quite a large set of options. It's beautiful and the coding is done quickly and
                                    seamlessly. Thank you! "</blockquote>
        ...
        <div class="container pb-3 pb-lg-5">
            <div class="w-lg-75 mx-lg-auto">
                <div class="row">
                    ...
                    <div class="col text-center py-3">
                        <img class="avatar avatar-lg avatar-4x3" src="./assets/svg/brands/mailchimp-dark.svg"
                            alt="Logo">
                    </div>
                    <!-- End Col -->
                ...
                <div class="col-sm-6 col-lg-5 mb-9 mb-sm-0">
                    ...
                    <div class="card zi-2" data-aos="fade-up">
                        <div class="card-body">
                                            ...
                                            <span class="form-switch-promotion-container">
                                                <span class="form-switch-promotion-body">
                                                    ...
                                                    <span class="form-switch-promotion-text">
                                                        <span class="badge bg-primary rounded-pill ms-1">Coming
                                                            soon</span>
                                                    </span>
                                                </span>
                                            </span>
                            ...
                            <div class="d-flex align-items-end">
                                <div class="flex-shrink-0">
                                    <img class="avatar avatar-xl avatar-4x3"
                                        src="./assets/img/illustrations/presenting.png" alt="Image Description">
                                </div>
                            ...
                            <div class="d-grid">
                                <a class="btn btn-primary btn-transition"
                                    href="https://themes.getbootstrap.com/product/front-multipurpose-responsive-template/">Get
                                    started</a>
                            </div>
                        </div>
                    </div>
        ...
        <!-- Signup Form -->
        <div id="hireUsSection" class="bg-dark rounded-2 mx-3 mx-xl-10"
                ...
                <div class="row justify-content-lg-between align-items-lg-center">
                    <div class="col-md-10 col-lg-5 mb-9 mb-lg-0">
                        ...
                        <figure>
                            ...
                            <blockquote class="blockquote blockquote-light">“ It has many landing page variations to
                                choose from, which one is always a big advantage. ”</blockquote>
                                ...
                                <form>
                                    <div class="row gx-3">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="mb-3">
                                                <label class="form-label visually-hidden"
                                                    for="hireUsFormLasttName">Last name</label>
                                                <input type="text" class="form-control form-control-lg"
                                    ...
                                    <div class="row gx-3">
                                        <div class="col-sm-6">
                                            ...
                                            <div class="mb-3">
                                                <label class="form-label visually-hidden"
                                                    for="hireUsFormBudget">Budget</label>
                                                <select id="hireUsFormBudget" class="form-select form-select-lg"
                                                    name="hireUsFormNameBudget" aria-label="Budget">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="mb-3">
                                                <label class="form-label visually-hidden"
                                                    for="hireUsFormCountry">Country</label>
                                                <select id="hireUsFormCountry" class="form-select form-select-lg"
                                                    name="hireUsFormNameCountry" aria-label="Country">
                                    ...
                                    <div class="form-check small mb-4">
                                        ...
                                        <label class="form-check-label" for="signupFormPrivacyCheck"> Yes, I'd like to
                                            receive occasional marketing emails from Front. I have the right to opt out
                                            at any time. <a class="link" href="./page-privacy.html">View
