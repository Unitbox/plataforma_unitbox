            ...
            <div class="row pt-2">
                <div class="col-md-8 mx-auto">
                    <ol class="breadcrumb d-flex justify-content-center">
                        <li class="breadcrumb-item text-success"><a href="{{ route('web.home') }}"
                                class="text-white text-underline">
                                <span class="text-underline">Página do Principal</a></li>
                        <li class="breadcrumb-item active text-primary">Política de privacidade</li>
                    </ol>
                    <h1 class="text-center d-block blog-title font-weight-bold text-center text-success font-weight-900">Política de Privacidade
                </h1>
                </div>
                <div class="col-md-8 mx-auto">
                    <p class="card-text text-white text-center">Última modificação: 15 de dezembro de 2021</p>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8 mx-auto blog-content py-3">
                        <p class="lead">A sua privacidade é importante para nós. É política da Unitbox respeitar a sua
                            privacidade
                            em relação a qualquer informação sua que possamos coletar no site <a
                                href={{ route('web.home') }}>Unitibox </a>.</p><br />
                        ...
                        <p>O nosso site pode ter links para sites externos que não são operados por nós. Esteja ciente
                            ...
                            responsabilidade por suas respectivas <a href='{{ route('web.privacidade') }}'>políticas
                                de
                                privacidade</a>. </p><br />
                        ...
                        <ul class="ul-blog">
                            ...
                            <li> Cookies relacionados ao login:<br> Utilizamos cookies quando você está logado, para que
                                possamos lembrar dessa ação. Isso evita que você precise fazer login sempre que visitar
                                uma
                            ...
                            <li> Cookies relacionados a pesquisas:<br> Periodicamente, oferecemos pesquisas e
                                ...
                                lembrar
                                quem já participou numa pesquisa ou para fornecer resultados precisos após a alteração
                                das
                                páginas.<br><br> </li>
                            ...
                            <li> Cookies de preferências do site:<br> Para proporcionar uma ótima experiência neste
                                ...
                                quando você o usa. Para lembrar suas preferências, precisamos definir cookies para que
                                essas
                                informações possam ser chamadas sempre que você interagir com uma página for afetada por
                                suas preferências.<br> </li>
                        </ul> <br>
                        <h3>Cookies de Terceiros</h3>
                        <p>Em alguns casos especiais, também usamos cookies fornecidos por terceiros confiáveis. A seção
                            a
                        ...
                        <ul class="ul-blog">
                            ...
                            <li>Vários parceiros anunciam em nosso nome e os cookies de rastreamento de afiliados
                                ...
                                permitir
                                que nossos parceiros afiliados ofereçam qualquer promoção que pode fornecê-lo para fazer
                                uma
                                compra. </li>
                        </ul> <br>
                        ...
                        <ul class="list-group list-group-flush ul-blog">
                            <li class="list-group-item">A) Não se envolver em atividades que sejam ilegais ou contrárias
                                à
                            ...
                            <li class="list-group-item">B) Não difundir propaganda ou conteúdo de natureza racista,
                                ...
                                sorte e azar, qualquer tipo de pornografia ilegal, de apologia ao terrorismo ou contra
                                os
                                direitos humanos;</li>
